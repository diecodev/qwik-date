    ...
    <section class="space-y-10">
      <div class="space-y-3">
        ...
        >
          <code class="pointer-events-none">
            npm install qwik-date qwik-sonner
          </code>
          <button
            class="absolute right-2 top-2 rounded-md border border-neutral-300 p-1 transition-all dark:border-neutral-600 dark:text-neutral-200"
            onClick$={() => copyToClipboard("#installation")}
          >
      ...
      <div class="space-y-3">
        ...
        <code
          ...
          id="usage"
        >
          <pre>{`import { Calendar } from "qwik-date";
